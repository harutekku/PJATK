...
insert into pracownik values ('5','Tekla','Woźniak','3','100');
...
insert into Czytelnik values ('2','Urjasz','Pawłowski','87052478070','Alpejska 95 85-790 Bydgoszcz');
insert into Czytelnik values ('3','Tytus','Ostrowski','40021803877','Biskupińska 43 60-463 Poznań');
insert into Czytelnik values ('4','Sylwia','Kwiatkowska','81071786769','Wawelska 9 80-034 Gdańsk');
insert into Czytelnik values ('5','Józefa','Kowalczyk','57040300245','Szronowa 73 60-375 Poznań');
...
insert into autor values ('2','Aleksander','Kamiński');
...
insert into ksiazka values ('1','List w butelce','1','1','Smutna historia o znalezionym liście');
insert into ksiazka values ('2','Szczęściarz','1','1','Opowieść o podróży żołnierza do ukochanej');
insert into ksiazka values ('3','Kamienie na szaniec','2','3','Opowieść o bohaterach szarych szeregów');
insert into ksiazka values ('4','Latarnik','3','4','Opowieść o życiu latarnika');
insert into ksiazka values ('5','Ogniem i mieczem','3','3','Opowieść o historii Polski');
insert into ksiazka values ('6','Był sobie pies','4','4','Przygodowa o piesku');
insert into ksiazka values ('7','Trzynasta opowieść','5','1','Opowieść o dwóch przyjaciółkach');
insert into ksiazka values ('8','Podróżniczka','5','4','Opowieść o kobiecie która uciekła podczas wojny');

insert into wydawnictwo values ('1','Albatros');
insert into wydawnictwo values ('2','Nasza księgarnia');
insert into wydawnictwo values ('3','Państwowe Zakłady Wydawnictw Szkolnych');
...
insert into wydawnictwo values ('7','Świat Książki');
